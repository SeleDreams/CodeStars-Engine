message(STATUS "Setting up the wonderful toolchain...")
include(${CMAKE_CURRENT_LIST_DIR}/WonderfulToolchain.cmake)
set(BLOCKSDS_ENV "$ENV{BLOCKSDS}")
set(BLOCKSDSEXT_ENV "$ENV{BLOCKSDSEXT}")
if(BLOCKSDS_ENV STREQUAL "")
message(FATAL_ERROR "The BLOCKSDS environment variable must be set!")
endif()
if (BLOCKSDSEXT_ENV STREQUAL "")
message(FATAL_ERROR "The BLOCKSDSEXT environment variable must be set!")
endif()
cmake_path(CONVERT ${BLOCKSDS_ENV} TO_CMAKE_PATH_LIST BLOCKSDS)
cmake_path(CONVERT ${BLOCKSDSEXT_ENV} TO_CMAKE_PATH_LIST BLOCKSDSEXT)
